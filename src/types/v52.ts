...
export type FlowState = FlowState_Init | FlowState_Active | FlowState_Paused | FlowState_Finalizing | FlowState_Reverting | FlowState_Success | FlowState_Failed | FlowState_Locked
