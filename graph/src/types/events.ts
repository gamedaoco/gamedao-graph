...
export class FlowCampaignContributedEvent {
  ...
  get isV51(): boolean {
    return this.ctx._chain.getEventHash('flow.CampaignContributed') === '468323ba2b1d06ed69cab44dae01b73effde3718b7f6fa45825f7ab33b4b3470'
  }
...
export class FlowCampaignCreatedEvent {
  ...
  get isV51(): boolean {
    return this.ctx._chain.getEventHash('flow.CampaignCreated') === '371b8f51721e1fd8ed81cf9a3772d6cc0f16c13a8914d6e2db030f98b0b8df78'
  }

  get asV51(): {campaignId: v51.H256, creator: v51.AccountId32, admin: v51.AccountId32, target: bigint, deposit: bigint, expiry: number, name: Uint8Array} {
    assert(this.isV51)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {campaignId: v51.H256, creator: v51.AccountId32, admin: v51.AccountId32, target: bigint, deposit: bigint, expiry: number, name: Uint8Array} {
    deprecateLatest()
    return this.asV51
  }
}
...
export class FlowCampaignFailedEvent {
  ...
  get isV51(): boolean {
    return this.ctx._chain.getEventHash('flow.CampaignFailed') === 'f8729adf95aca79ce70a6bf7e5552c2fbca3c375bd8d28e1c244ab667301a78e'
  }
...
export class FlowCampaignFinalizedEvent {
  ...
  get isV51(): boolean {
    return this.ctx._chain.getEventHash('flow.CampaignFinalized') === 'fc15b0acbdb489eb2e0dabd16a4be053f3ca74fb78406c41d8e49d6946894452'
  }
...
export class FlowCampaignUpdatedEvent {
  ...
  get isV51(): boolean {
    return this.ctx._chain.getEventHash('flow.CampaignUpdated') === '374ef9f1f9e74398ef5466b31f981fbefc95ea63a0d7fd9dc3f519442cafda62'
  }
