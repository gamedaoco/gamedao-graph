module.exports = class AddOrganization1652116991172 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "organization" ("id" character varying NOT NULL, "creator" text NOT NULL, "controller" text NOT NULL, "treasury" text NOT NULL, "cid" text NOT NULL, "access" text NOT NULL, "fee_model" text NOT NULL, "type" text NOT NULL, "fee" numeric NOT NULL, "gov_asset" integer NOT NULL, "pay_asset" integer NOT NULL, "member_limit" numeric NOT NULL, "creator_identity_id" character varying NOT NULL, "controller_identity_id" character varying NOT NULL, "treasury_identity_id" character varying NOT NULL, "metadata_id" character varying NOT NULL, CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`)
