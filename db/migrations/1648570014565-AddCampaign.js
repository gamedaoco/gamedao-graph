module.exports = class AddCampaign1648570014565 {
	...
	async up(db) {
		await db.query(
			`CREATE TABLE "campaign" ("id" character varying NOT NULL, "admin" text NOT NULL, "target" numeric NOT NULL, "deposit" numeric NOT NULL, "expiry" integer NOT NULL, "protocol" integer NOT NULL, "governance" integer NOT NULL, "cid" text NOT NULL, "token_symbol" text NOT NULL, "token_name" text NOT NULL, "body_id" character varying NOT NULL, CONSTRAINT "PK_0ce34d26e7f2eb316a3a592cdc4" PRIMARY KEY ("id"))`,
		);
