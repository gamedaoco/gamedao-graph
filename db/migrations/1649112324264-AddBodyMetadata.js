module.exports = class AddBodyMetadata1649112324264 {
	...
	async up(db) {
		await db.query(
			`CREATE TABLE "body_metadata" ("id" character varying NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "website" text NOT NULL, "email" text NOT NULL, "repo" text NOT NULL, "logo" text NOT NULL, CONSTRAINT "PK_5105292531c32aab14a33a02c4b" PRIMARY KEY ("id"))`,
		);
		...
		await db.query(
			`ALTER TABLE "body" ADD CONSTRAINT "FK_5105292531c32aab14a33a02c4b" FOREIGN KEY ("metadata_id") REFERENCES "body_metadata"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
		);
	}
